 ...
 * intervals.
 */
@Plugin(name = "TestRollingRandomAccessFile", category = "Core", elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class TestRollingRandomAccessFileAppender extends AbstractOutputStreamAppender<RollingRandomAccessFileManager> {
    ...
    private TestRollingRandomAccessFileAppender(final String name, final Layout<? extends Serializable> layout,
    ...
    /**
     * Create a TestRollingRandomAccessFileAppender.
     *
     ...
     * @return A TestRollingRandomAccessFileAppender.
     */
    @PluginFactory
    public static TestRollingRandomAccessFileAppender createAppender(
        ...
        return new TestRollingRandomAccessFileAppender(name, layout, filter, manager,
